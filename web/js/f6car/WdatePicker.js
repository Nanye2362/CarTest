...
(function () {
    ...
    if (!V.$dp)
        V.$dp = {ff: G, ie: S, opera: c, status: 0, defMinDate: $.minDate, defMaxDate: $.maxDate};
    B();
    ...
    function B() {
        ...
        var A = {win: Y, $: function ($) {
                ...
                var A = V[N].getElementsByTagName("div"), $ = 100000000;
        ...
        function E(K, J) {
            ...
            function C() {
                ...
                for (var C = 0; C < D.length; C++)
                    if (D[C].name == J.skin)
                        $.push("<link rel=\"stylesheet\" type=\"text/css\" href=\"" + A + "skin/" + D[C].name + "/datepicker.css\" charset=\"" + D[C].charset + "\"/>");
