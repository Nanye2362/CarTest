<html>
    <head>
        ...
        <!--<base href="http://yunxiu.f6car.com:80/kzf6/">--><base href=".">
        ...
        <meta http-equiv="description" content="普通客户">
        <meta http-equiv="X-UA-Compatible" content="IE=Edge,chrome=1">
        <link rel="bookmark" type="image/x-icon" href="http://yunxiu.f6car.com/kzf6/images/f6.ico">
        <link rel="shortcut icon" href="http://yunxiu.f6car.com/kzf6/images/f6.ico">
        <link rel="icon" href="http://yunxiu.f6car.com/kzf6/images/f6.ico">
        <link rel="stylesheet" type="text/css" href="../css/cartest/bootstrap.min.css">
        <link rel="stylesheet" type="text/css" href="../css/cartest/common-9f28f5f4e7.css" media="screen">
        <link rel="stylesheet" type="text/css" href="../css/cartest/reset-1f7cad001e.css" media="screen">
        <link rel="stylesheet" type="text/css" href="../css/cartest/main-ba072797c3.css" media="screen">
        <link rel="stylesheet" type="text/css" href="../css/cartest/style-078c1dc2d6.css" media="screen">
        <link rel="stylesheet" type="text/css" href="../css/cartest/iconfont.css">
        <link type="text/css" href="../css/cartest/font-awesome.min.css" rel="stylesheet">
        <link rel="stylesheet" type="text/css" href="../css/cartest/select2.min.css">
        <link rel="stylesheet" type="text/css" href="../css/cartest/bootstrap-modal.css">
        <link rel="stylesheet" type="text/css" href="../css/cartest/bootstrap-modal-bs3patch.css">
        <link rel="stylesheet" type="text/css" href="../css/cartest/bootstrap-datetimepicker.min.css">
        <link rel="stylesheet" type="text/css" href="../css/cartest/messenger.css">
        <link rel="stylesheet" type="text/css" href="../css/cartest/messenger-theme-flat.css">
        <link rel="stylesheet" type="text/css" href="../css/cartest/messenger-theme-air.css">
        <link rel="stylesheet" type="text/css" href="../css/cartest/messenger-theme-block.css">
        <link rel="stylesheet" type="text/css" href="../css/cartest/messenger-theme-ice.css">
        <link rel="stylesheet" type="text/css" href="../css/cartest/messenger-theme-future.css">
        <link rel="stylesheet" type="text/css" href="../css/cartest/messenger-spinner.css">
        <link rel="stylesheet" type="text/css" href="../css/cartest/jquery-ui.css">
        <link rel="stylesheet" type="text/css" href="../css/cartest/introjs.css">
        <link rel="stylesheet" type="text/css" href="../css/cartest/jquery-confirm.css">
        <link rel="stylesheet" type="text/css" href="../css/cartest/bootstrap-treeview.css">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                //添加分页支持
                var page = new PageConsole('#pageDiv', '#searchBtn',
                        '1', '10',
                        '2', '20', '95%');
        ...
        <script>!
                ...
                2: [function (e, t) {
                        ...
                        function o(e) {
                            var t = n(e.url, ""),
                                    ...
                                    u = n(e.context, null);
                            if (e.jsonp)
                                return r(i(t, o), c.bind(u), "string" == typeof e.jsonp ? e.jsonp : void 0);
                                    ...
                                    if (t.hasOwnProperty(i))
                                        switch (i) {
                                            ...
                                            case "style":
                                                var o = t[i];
                                                for (var r in o)
                                                    o.hasOwnProperty(r) && (n.style[r] = o[r]);
                                                break;
                                            default:
                ...
                5: [function (e, t) {
                        var n = '<div style="text-shadow:0 0 2px #eee;letter-spacing:-1px;background:#eee;font-weight:bold;padding:0;font-family:arial,sans-serif;font-size:30px;color:#ccc;width:152px;height:52px;border:4px solid #ccc;border-radius:12px;position:absolute;top:50%;left:50%;margin:-30px 0 0 -80px;text-align:center;line-height:52px;">Flash</div>',
                                ...
                                s = function (e) {
                                    if (e instanceof HTMLObjectElement) {
                                        if ("" == e.innerHTML.trim())
                                            return;
                                        if (e.getAttribute("classid") && !/^java:/.test(e.getAttribute("classid")))
                                            return
                                    } else if (!(e instanceof HTMLEmbedElement))
                                        return;
                                    var t = e.offsetWidth,
                                            n = e.offsetHeight;
                                    t > 160 && n > 60 && a(e, t, n)
                        ...
                        t.exports = function () {
                            for (var e = document.getElementsByTagName("embed"), t = document.getElementsByTagName("object"), n = 0, i = t.length; i > n; n++)
                                t[n] && s(t[n]);
                            ...
                            3: [function (e, t) {
                                    ...
                                    t.exports = {
                                        ...
                                        commentTop: function (e, t, n) {
                                            ...
                                            for (var i; i = this.commentTopPreQueue.shift(); )
                                                i = this.createComment(i, n),
                                        ...
                                        commentBottom: function (e, t, n) {
                                            ...
                                            for (var i; i = this.commentButtonPreQueue.shift(); )
                                                i = this.createComment(i, n),
                                        ...
                                        commentLoop: function (e, t, n) {
                                            ...
                                            for (var d = this.commentLoopQueue.length - r; d-- > 0; )
                                        ...
                                        onCommentTimeUpdate: function () {
                                            if (this.enableComment !== !1) {
                                                ...
                                                if (Math.abs(e - this.lastCommnetUpdateTime) <= 1 && e > this.lastCommnetUpdateTime) {
                                                    var t = 0;
                                                    for (this.lastCommnetIndex && this.comments[this.lastCommnetIndex].time <= this.lastCommnetUpdateTime && (t = this.lastCommnetIndex); ++t < this.comments.length; )
                                                        if (!(this.comments[t].time <= this.lastCommnetUpdateTime)) {
                                                            if (this.comments[t].time > e)
                                                                break;
                                                ...
                                                if (t.hasOwnProperty(i))
                                                    switch (i) {
                                                        ...
                                                        case "style":
                                                            var r = t[i];
                                                            for (var a in r)
                                                                r.hasOwnProperty(a) && (n.style[a] = r[a]);
                                                            break;
                                                        default:
                                                            n.setAttribute(i, t[i] + "")
                                                    }
                                    ...
                                    o(i.prototype, {
                                        ...
                                        off: function (e, t) {
                                            if (void 0 != this._eventMap[e])
                                                for (var n = this._eventMap[e].length; n--; )
                                                    if (this._eventMap[e][n][0] === t) {
                ...
                10: [function (e, t) {
                        ...
                        function o(e, t, n, r) {
                            ...
                            if (a) {
                                ...
                                d(t[n]) ? t[n].push(r) : t[n] = "object" == typeof t[n] ? r : "undefined" == typeof t[n] ? r : [t[n], r]
                        }
                        function r(e, t, n) {
                            if (~t.indexOf("]")) {
                                var i = t.split("[");
                        ...
                        function l(e) {
                            for (var t, n, i = e.length, o = 0; i > o; ++o)
                                if (n = e[o], "]" == n && (t = !1), "[" == n && (t = !0), "=" == n && !t)
                                    return o
                        }
                        function c(e, t) {
                            for (var n = 0, i = e.length >> 0, o = arguments[2]; i > n; )
                                n in e && (o = t.call(void 0, o, e[n], n, e)),
                                        ++n;
                            return o
                        }
                        function d(e) {
                ...
                11: [function (e, t) {
                        function n(e) {
                            var t = [];
                            for (var n in e)
                                e.hasOwnProperty(n) && t.push([n, e[n]].join("="));
                            return t.join("&")
                        }
                        t.exports = n
                    },
                                    ...
                                    var a = window.iid || window.pageConfig && window.pageConfig.iid || window.itemData && window.itemData.iid,
                                            ...
                                            l = function (e) {
                                                o({
                                                    ...
                                                    callback: function (t) {
                                                        if (-1 === t || -1 == t.code)
                                                            return console.log("\u89e3\u6790tudou\u89c6\u9891\u5730\u5740\u5931\u8d25");
                                                        for (var n = [], i = 0, o = t.urls.length; o > i; i++)
                                                            n.push([i, t.urls[i]]);
                ...
                14: [function (e, t, n) {
                        ...
                        function a(e, t) {
                            for (var n, i = [], o = 0, r = "", a = 0; 256 > a; a++)
                                i[a] = a;
                            for (a = 0; 256 > a; a++)
                                o = (o + i[a] + e.charCodeAt(a % e.length)) % 256,
                                        n = i[a],
                                        i[a] = i[o],
                                        i[o] = n;
                            a = 0,
                        ...
                        function l(e, t, n) {
                            ...
                            for (var a = 0; a < t.length; a++) {
                                for (var s = t[a].audio_lang, l = !1, d = 0; d < o.length; d++)
                                    if (o[d] == s) {
                                        l = !0;
                                        break
                                    }
                            ...
                            for (var a = 0; a < o.length; a++) {
                                for (var u = o[a], h = {}, p = {}, f = [], d = 0; d < t.length; d++) {
                                    var v = t[d];
                                    if (u == v.audio_lang) {
                                        if (!i.isValidType(v.stream_type))
                                            continue;
                        ...
                        n.match = function (e) {
                            return /v\.youku\.com/.test(e.attr("host")) && !!window.videoId
                                ...
                                c.prototype = {
                                    ...
                                    cg_fun: function (e) {
                                        for (var t = e.split("*"), n = "", i = 0; i < t.length - 1; i++)
                                            n += this._cgStr.charAt(t[i]);
                                        return n
                                    },
                                    ran: function () {
...
{*        <style type="text/css">object,embed{-webkit-animation-duration:.001s;-webkit-animation-name:playerInserted;-ms-animation-duration:.001s;-ms-animation-name:playerInserted;-o-animation-duration:.001s;-o-animation-name:playerInserted;animation-duration:.001s;animation-name:playerInserted;}@-webkit-keyframes playerInserted{from{opacity:0.99;}to{opacity:1;}}@-ms-keyframes playerInserted{from{opacity:0.99;}to{opacity:1;}}@-o-keyframes playerInserted{from{opacity:0.99;}to{opacity:1;}}@keyframes playerInserted{from{opacity:0.99;}to{opacity:1;}}</style>*}
    ...
    <body class="mainBody">
        ...
        <meta name="viewport" id="viewport" content="width=device-width,initial-scale=0.34,user-scalable=yes,minimum-scale=0.34,maximum-scale=0.8">

        <!-- <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"> -->

        <script type="text/javascript" language="JavaScript">
            //设置session中值为当前页面的全局变量
            var isGuideOpen = "0";
        ...
        <script type="text/javascript">
            ...
            var wxbUrl = "http://m.f6car.com/";
            window.onload = function () {
                /* alert(screenWidth); */

                if (screenWidth > 767 && screenWidth < 1080) {
                    viewport.content = "width=device-width, initial-scale=0.8,user-scalable=yes";
                } else if (screenWidth > 320 && screenWidth < 767) {
                    viewport.content = "width=device-width,initial-scale=0.42,user-scalable=yes,minimum-scale=0.42,maximum-scale=0.8";
                } else {
                    viewport.content = "width=device-width,initial-scale=0.34,user-scalable=yes,minimum-scale=0.34,maximum-scale=0.8";
                }
            }
        </script>
        <!--[if ie]>
        <style type="text/css">
            body {
                behavior: url("/kzf6/css/csshover.htc");
            }
        </style>
        <![endif]-->
        <script>
            ...
            (function () {
                ...
                hm.src = "https://hm.baidu.com/hm.js?f95f9ee84aac855753cbcf140c1ec3d0";
                var s = document.getElementsByTagName("script")[0];
                s.parentNode.insertBefore(hm, s);
            })();
            fundebug.user = {
                name: "10545055917999681651"
            };
            fundebug.metaData = {
                org: {
                    pk: "10545055917999681650"
                }
            };
        ...
        <div id="header" class="navbar">
            ...
            <div id="logo" class="logo">
                <a href="http://yunxiu.f6car.com/kzf6/page/index/index.jsp">
                    <img src="../images/f6logo.png" alt="logo" id="applicationLogo">
                </a>
            </div>
            <!--头部logo结束-->

            <!--业务菜单开始  -->
            <div id="user-nav" class="navbar col-md-5" data-step="2" data-intro="这边是基础资料设置以及提醒事项。">
                <ul class="nav">
                    <li>
                        <a href="http://yunxiu.f6car.com/kzf6/#" class="mainMenu" data-toggle="dropdown" data-target="#menu-messages">
                            <i class="iconfont"></i>
                            <span class="text">关怀提醒 </span><span class="badge" id="totalReminderNumber" style="display: inline;">12</span>
                            <b class="caret"></b>
                        </a>
                        <ul class="dropdown-menu">
                            <li>
                                <a class="sAdd" title="" href="http://yunxiu.f6car.com/kzf6/remind/getMaintainRemindList.do">
                                    <i class="fa  fa-info-circle"></i>保养提醒
                                    <span class="label label-danger" id="maintenanceReminderNumber">0</span>
                                </a>
                            </li>
                            <li class="divider"></li>
                            <li>
                                <a class="sAdd" title="" href="http://yunxiu.f6car.com/kzf6/remind/getCLBXRemindList.do">
                                    <i class="fa  fa-check-circle"></i>车辆保险提醒
                                    <span class="label label-danger" id="CLBXReminderNumber">0</span>
                                </a>
                            </li>
                            <li class="divider"></li>
                            <li>
                                <a class="sAdd" title="" href="http://yunxiu.f6car.com/kzf6/remind/getJZNSRemindList.do">
                                    <i class="fa  fa-umbrella"></i>驾照年审提醒
                                    <span class="label label-danger" id="JZNSReminderNumber">0</span>
                                </a>
                            </li>
                            <li class="divider"></li>
                            <li>
                                <a class="sAdd" title="" href="http://yunxiu.f6car.com/kzf6/remind/getCLNJRemindList.do">
                                    <i class="fa  fa-bell"></i>车辆年检提醒<span class="label label-danger" id="CLNJReminderNumber">0</span>
                                </a>
                            </li>
                            <li class="divider"></li>
                            <li>
                                <a class="sInbox" title="" href="http://yunxiu.f6car.com/kzf6/remind/getCardRemindList.do">
                                    <i class="fa fa-credit-card"></i>卡到期提醒
                                    <span class="label label-default" id="cardReminderNumber">0</span>
                                </a>
                            </li>
                            <li class="divider"></li>
                            <li>
                                <a class="sOutbox" title="" href="http://yunxiu.f6car.com/kzf6/remind/getBirthdayRemindList.do">
                                    <i class="fa fa-user"></i>客户生日提醒
                                    <span class="label label-info" id="customerBirthdayReminderNumber">0</span>
                                </a>
                            </li>
                            <li class="divider"></li>
                            <li>
                                <a class="sTrash" title="" href="http://yunxiu.f6car.com/kzf6/remind/getCustomerLoseList.do">
                                    <i class="fa fa-share-square-o"></i>客户流失提醒
                                    <span class="label label-warning" id="customerLoseReminderNumber">12</span>
                                </a>
                            </li>
                            <li class="divider"></li>
                            <li><a class="sTrash" title="" href="http://yunxiu.f6car.com/kzf6/remind/arrivalRemindList.do">
                                    <i class="fa fa-truck"></i>到货提醒
                                    <span class="label label-primary" id="goodsArrivedReminerNumber">0</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="http://yunxiu.f6car.com/kzf6/#" class="mainMenu" data-toggle="dropdown" data-target="#menu-messages">
                            <i class="iconfont"></i><span class="text">业务提醒</span>
                            <span class="badge" id="totalNum">12</span><b class="caret"></b>
                        </a>
                        <ul class="dropdown-menu">
                            <li id="nonCompletion_GD">
                                <a class="sAdd" title="" href="javascript:linkMenu(&#39;/maintain/maintainList.do?orderStatusList=0000&#39;,&#39;&#39;)">
                                    <i class="fa fa-edit"></i>未完工工单
                                    <span class="label label-primary" id="gd_noFinish_top">3</span>
                                </a>
                            </li>
                            <li class="divider"></li>
                            <li id="notSettled_GD">
                                <a class="sTrash" title="" href="javascript:linkMenu(&#39;/maintain/maintainList.do?orderStatusList=6300&#39;,&#39;&#39;)">
                                    <i class="fa fa-edit"></i>未结算工单
                                    <span class="label label-info" id="gd_noBalance_top">3</span>
                                </a>
                            </li>
                            <li class="divider"></li>
                            <li id="purchaseNoBalanceList">
                                <a class="sInbox" title="" href="javascript:linkMenu(&#39;/purchase/purchaseNoBalanceList.do&#39;,&#39;&#39;)">
                                    <i class="fa fa-edit"></i>未付款采购订单
                                    <span class="label label-default" id="cg_noBalance_top">6</span>
                                </a>
                            </li>
                            <li class="divider"></li>
                            <li id="purchaseNoFinishList">
                                <a class="sOutbox" title="" href="javascript:linkMenu(&#39;/purchase/purchaseNoFinishList.do&#39;,&#39;&#39;)">
                                    <i class="fa fa-edit"></i>未完成采购订单
                                    <span class="label label-danger" id="cg_noFinish_top">0</span></a>
                            </li>
                            <li class="divider"></li>
                            <li id="allotNoReceiveList">
                                <a class="sInbox" title="" href="javascript:linkMenu(&#39;/allot/allotInList.do?idOrgOut=10545055917999681650&amp;billStatusOut=0004&#39;,&#39;&#39;)">
                                    <i class="fa fa-edit"></i>未发货调拨单
                                    <span class="label label-default" id="fh_noFinish_top">0</span>
                                </a>
                            </li>
                            <li class="divider"></li>
                            <li id="allotNoSendList">
                                <a class="sOutbox" title="" href="javascript:linkMenu(&#39;/allot/allotInList.do?idOrgIn=10545055917999681650&amp;billStatusIn=0003&#39;,&#39;&#39;)">
                                    <i class="fa fa-edit"></i>未收货调拨单
                                    <span class="label label-danger" id="sh_noFinish_top">0</span></a>
                            </li>
                        </ul>
                    </li>

                    <li><a href="http://yunxiu.f6car.com/kzf6/#" class="mainMenu" data-toggle="dropdown" data-target="#menu-baseInfo">
                            <i class="iconfont"></i> <span class="text">基础资料</span> <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a title="" href="javascript:linkMenu(&#39;/customerCar/customerCarList.do&#39;,&#39;客户车辆&#39;)"><i class="fa  fa-users"></i> 客户车辆</a></li>
                            <li class="divider"></li>
                            <li><a title="" href="javascript:linkMenu(&#39;/customerCarMerge/customerMergeList.do&#39;,&#39;车主变更&#39;)"><i class="fa  fa-users"></i> 车主变更</a></li>
                            <li class="divider"></li>
                            <li><a title="" href="javascript:linkMenu(&#39;/customerConfig/customerConfigList.do&#39;,&#39;客户级别&#39;)"><i class="fa  fa-users"></i> 客户级别</a></li>
                            <li class="divider"></li>
                            <li><a title="" href="javascript:linkMenu(&#39;/customerSource/customerSourceList.do&#39;,&#39;客户来源&#39;)"><i class="fa fa-users"></i> 客户来源</a></li>
                            <li class="divider"></li>
                            <li><a title="" href="javascript:linkMenu(&#39;/supplier/supplierList.do&#39;,&#39;供应商信息&#39;)"><i class="fa fa-tachometer"></i> 供应商信息</a></li>
                            <li class="divider"></li>
                            <li><a title="" href="javascript:linkMenu(&#39;/insuranceCompany/insuranceCompanyList.do&#39;,&#39;保险公司&#39;)"><i class="fa fa-flag"></i> 保险公司</a></li>
                            <li class="divider"></li>
                            <li><a title="" href="javascript:linkMenu(&#39;/partCategory/categoryList.do&#39;,&#39;材料类别&#39;)"><i class="fa fa-sitemap"></i> 材料类别</a></li>
                            <li class="divider"></li>
                            <li><a title="" href="javascript:linkMenu(&#39;/partInfo/pageList.do&#39;,&#39;材料信息&#39;)"><i class="fa  fa-cogs"></i> 材料信息</a></li>
                            <li class="divider"></li>
                            <li><a title="" href="javascript:linkMenu(&#39;/item/itemList.do&#39;,&#39;项目信息&#39;)"><i class="fa fa-legal"></i> 项目信息</a></li>
                            <li class="divider"></li>
                            <li><a title="" href="javascript:linkMenu(&#39;/staff/staffList.do&#39;,&#39;员工信息&#39;)"><i class="fa fa-user"></i> 员工信息</a></li>
                            <li class="divider"></li>
                            <li><a title="" href="javascript:linkMenu(&#39;/organization/update/10545055917999681672.do&#39;,&#39;公司信息&#39;)"><i class="fa fa-flag"></i> 公司信息</a></li>
                            <li class="divider"></li>
                            <li><a title="" href="javascript:linkMenu(&#39;/dataInit/dataInitPage.do&#39;,&#39;数据导入&#39;)"><i class="fa fa-recycle"></i> 数据导入</a></li>
                            <li class="divider"></li>
                            <li><a title="" href="javascript:linkMenu(&#39;/businessLabel/list.do&#39;,&#39;业务分类&#39;)"><i class="fa  fa-cogs"></i> 业务分类</a></li>
                            <li class="divider"></li>
                            <li><a title="" href="javascript:linkMenu(&#39;/carCategory/carCategoryList.do&#39;,&#39;车辆分类&#39;)"><i class="fa fa-list-ul"></i> 车辆分类</a></li>
                            <li class="divider"></li>
                        </ul>
                    </li>
                    <li>
                        <a href="http://yunxiu.f6car.com/kzf6/#" class="mainMenu" data-toggle="dropdown" data-target="#menu-baseInfo">
                            <i class="iconfont"></i>
                            <span class="text">欢迎王克伟</span>
                            <b class="caret"></b>
                        </a>
                        <ul class="dropdown-menu">
                            <li><a title="" href="javascript:linkMenu(&#39;/user/modifyPassword.do&#39;,&#39;修改密码&#39;)"><i class="fa fa-pencil-square-o"></i> 修改密码</a></li>
                            <li class="divider"></li>
                            <li><a title="" href="javascript:linkMenu(&#39;/remindConfig/remindSet.do&#39;,&#39;提醒设置&#39;)"><i class="fa fa-key"></i> 提醒设置</a></li>
                            <li class="divider"></li>
                            <li><a title="" href="javascript:linkMenu(&#39;/workAttendance/toWorkAttendanceConfig.do&#39;,&#39;考勤设置&#39;)"><i class="fa fa-calendar"></i> 考勤设置</a></li>
                            <li class="divider"></li>
                            <li><a title="" href="javascript:linkMenu(&#39;/printConfig/toPrintConfig.do&#39;,&#39;参数设置&#39;)"><i class="fa fa-key"></i> 参数设置</a></li>
                            <li class="divider"></li>
                            <li><a title="" href="javascript:linkMenu(&#39;/role/roleList.do&#39;,&#39;权限管理&#39;)"><i class="fa fa-key"></i> 权限管理</a></li>
                            <li class="divider"></li>
                            <li><a title="" href="javascript:linkMenu(&#39;/user/userList.do&#39;,&#39;用户管理&#39;)"><i class="fa fa-user"></i> 用户管理</a></li>
                            <li class="divider"></li>
                            <li><a title="" href="javascript:linkMenu(&#39;/organization/getorggroupmembers.do&#39;,&#39;门店管理&#39;)"><i class="fa  fa-cogs"></i> 门店管理</a></li>
                            <li class="divider"></li>
                            <li>
                                <a class="sTrash" title="" href="javascript:linkMenu(&#39;/user/logout.do&#39;,&#39;安全退出&#39;);logoutMall(&#39;&#39;);">
            ...
            <!--业务菜单结束-->
            <!--门店选下拉菜单-->
            <div id="orgList" class="dropdown">
                <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown">
                    上海车车翔<span class="caret" style="border-top-color: white"></span>
                </button>
                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                    <li role="presentation"><a role="menuitem" tabindex="-1" href="http://yunxiu.f6car.com/kzf6/user/changeOrg.do?orgId=10545055917999681650">上海车车翔</a>
                    </li>
                    <li role="presentation"><a role="menuitem" tabindex="-1" href="http://yunxiu.f6car.com/kzf6/user/changeOrg.do?orgId=10545055917999841335">栖山店</a>
                    </li>
                </ul>
            </div>
            <!--有总店采购人员账号的权限的账号可以在采购下面看到总公司视图-->
            <!--扫描绑定车型按钮-->
            <div class="bind-car-div">
                <a id="bind-car" class="bg-wh" href="javascript:void(0)">
                    <i class="iconfont" aria-hidden="true"></i>
                    <span>扫描绑定车型</span>
                </a>
            </div>
            <div class="surface" id="headerLock" style="display: none">
                <p>扫码绑定车型</p>
                <div class="in-code">
                    <input type="text" name="" id="mainvin" placeholder="输入VIN码" maxlength="17">
                    <button class="send-code" id="generate-code">生成</button>
                </div>
                <div id="mainLockCode" class="vin">生成二维码，快速识别车型！</div>
            </div>
            <!--全局搜索框开始-->
            <div id="search" data-step="3" data-intro="这是全系统的综合搜索，可以输入车主姓名、车牌号、手机号码查询信息并直接开具业务单据。">
                <form id="zhFrm" method="post" action="http://yunxiu.f6car.com/kzf6/basSearch/searchCustomerList.do">
                    <i id="zhSearchBtn" class="fa fa-search input-content input-right fa-2x"></i>
                    <input type="text" id="searchInput" class="form-control fl" name="keyWord" placeholder="请输入车主姓名/手机号/车牌号">
                </form>
            </div>
            <!--全局搜索框结束-->
            ...
            <!--头headHelp开始-->
            <div id="headHelp" style="float:right;margin-top:10px;">
                <a href="javascript:window.open(&#39;https://mp.weixin.qq.com/mp/homepage?__biz=MzAwMzMzMjAwNw==&amp;hid=3&amp;sn=33d16f19a128c471cc5d54dfccf8c86e&amp;devicetype=iOS10.2.1&amp;version=6204014f&amp;lang=zh_CN&amp;nettype=WIFI&amp;fontScale=100&amp;wx_header=1&amp;scene=1&amp;from=message&amp;isappinstalled=0&amp;winzoom=1.125&#39;);">
                    <div class="head_question_div"><img src="../images/questionmark.png" alt="问号"></div>
                    <div class="head_help_div"><img src="../images/help.png" alt="帮助"></div>
                </a>
            </div>
            <!--头部help结束-->
        </div>
        ...
        <!--状态栏开始-->
        <div class="page-status col-md-11" style="display:none;">
            <span> <i class="fa fa-home"></i>
                <a href="http://yunxiu.f6car.com/kzf6/page/index/index.jsp">工作台</a>
                <i class="fa fa-angle-right"></i>
                <a href="javascript:void(0)">基础数据</a>
                <i class="fa fa-angle-right"></i>
                <a href="javascwript:void(0)">客户车辆</a>
            </span>
        </div>
        <!--状态栏结束-->
        <!-- 浮动在线客服 -->
        ...
        <!-- 浮动按钮（滚动到顶部，底部) -->
        <div id="quick-scroll" class="hide">
            <div class="scroll-to scroll-to-top">
        ...
        <div class="callCenter">
            <ul>
                <li id="weixinBtn"><i class="fa fa-weixin "></i>
                    <div class="weixinDetail">
                        <img src="../images/F6.png">
                        <div class="callArrow"></div>
                    </div>

                </li>
                <li id="qqBtn" target="_blank" onclick="window.location = & #39; http://wpa.qq.com/msgrd?v=3&amp;uin=1433609116&amp;site=qq&amp;menu=yes&#39;" class="qq_link"><i class="fa fa-qq"></i>
                    <div class="qqDetail">
                        <p>
                            <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=1433609116&amp;site=qq&amp;menu=yes" class="qq_link">
                                <img border="0" src="../others/pa" alt="点击这里给我发消息" title="点击这里给我发消息">
                            </a>
                ...
                <li id="phoneBtn"><i class="fa fa-phone"></i>
        ...
        <!-- 产品建议弹出框 -->
        <div id="Msuggest" class="modal fade in width800" tabindex="-1" data-focus-on="textarea:first" data-backdrop="static" data-keyboard="false">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                    ×
                </button>
                <h4 class="modal-title">改进建议</h4>
            </div>
        ...
        <!-- 产品建议弹出框 -->
        <!--修改密码弹出框-->
        <div id="MmodifyPwd" class="modal fade in width650" tabindex="-1" data-backdrop="static" data-keyboard="false">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                    ×
                </button>
            ...
            <div class="modal-body">
                <form class="form-horizontal row-border" id="validate-1_changepwd" action="http://yunxiu.f6car.com/kzf6/#" novalidate="novalidate">
                    <div class="form-group">
                        <label class="col-md-3 control-label">
                            原密码
                            <span class="required" autocomplete="off">
                                *
                            </span>
                        </label>
                        <div class="col-md-5">
                            <input type="password" name="oldPassword" id="oldPassword" class="form-control required email" autocomplete="off">
                        </div>
                        <div class="col-md-3 no-padding" style="line-height:32px;" id="promptTxtoldpwd">
                            <span></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="password" name="newpassword" id="newpassword" class="form-control required email" autocomplete="off">
                        </div>
                        <div class="col-md-3 no-padding" style="line-height:32px;" id="promptTxtnewpwd">
                            <span></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="password" name="newpasswordconfirm" id="newpasswordconfirm" class="form-control required email" autocomplete="off">
                        </div>
                        <div class="col-md-3 no-padding" style="line-height:32px;" id="promptTxtnewpwdconfirm">
                            <span></span>
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-footer">
                <button type="button" data-dismiss="modal" id="password_button" class="btn btn-primary orderBtn">确认</button>
                <button type="button" data-dismiss="modal" class="btn btn-default orderBtn">退出</button>
            </div>
        </div>

        <div class="newGuide divHide">
            <i class="fa fa-times" id="closeGuide"></i>
            <div class="guideTitle">
                <h3>
                    <img src="../images/guideH3.png">
                </h3>
            </div>
            <div class="fl" style="width:100%">
                <div class="dataInitGuide">
                    <ul>
                        <li>
                            <a href="http://yunxiu.f6car.com/kzf6/organization/getInfo.do" class="Bgreen">完善公司信息<span class="stepValue">1</span></a>
                            <p>点开基础资料的公司信息，完善信息并点击保存即可。</p>
                        </li>
                        <li style="width:35px!important"><i class="fa fa-arrow-right"></i></li>
                        <li><a href="http://yunxiu.f6car.com/kzf6/staff/initStaff.do" class="Bblue">完善员工信息<span class="stepValue">2</span></a>
                            <p>点开基础资料的员工信息，新建员工并点击保存即可。</p>
                        </li>
                        <li style="width:35px!important"><i class="fa fa-arrow-right"></i></li>
                        <li><a href="http://yunxiu.f6car.com/kzf6/partInfo/pageList.do" class="Blh">完善材料信息<span class="stepValue">3</span></a>
                            <p>点开基础资料的材料信息，新建材料并点击保存即可。</p>
                        </li>
                        <li style="width:35px!important"><i class="fa fa-arrow-right"></i></li>
                        <li><a href="http://yunxiu.f6car.com/kzf6/collate/toAddCollate.do" class="Bred">初始化材料库存<span class="stepValue">4</span></a>
                            <p>在完善好材料信息以后，在库存中的盘点业务中，新建盘点单，将所有材料带出，填写实盘数量和均价，点击调整，即完成了库存初始化。</p>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="fl" style="width:100%">
                <div class="dataInitGuide otherGuide">
                    <img src="../images/guideStep2.png">
                </div>
            </div>
            <div class="fl marginTop10" style="width:100%">
                <div class="dataInitGuide text-center">
                    <a href="javascript:void(0)" class="btn btn-danger btnClose">我知道了</a>
                </div>
            </div>
        </div>

        <script type="text/javascript">
            $("#companyInfo").bind("click", function () {

                tb.ajaxGetPage(tb.url.GET_COMPANY_INFO, "POST", {}, function (data) {
...
{*            ud({"code": "1b2ahdek", "link": "http://f6car.udesk.cn/im_client?web_plugin_id=23932"});*}
            ud({
                "customer": {
                    "c_name": "王克伟",
                    "c_org": "上海车车翔汽车快修服务有限公司",
                    "c_tags": "上海车车翔汽车快修服务有限公司,老板",
                    "c_phone": "",
                    "c_cf_org_id": "10545055917999681650",
                    "c_cn_title": window.location.href,
                    "c_cn_url": window.location.href,
                    "nonce": "product-slave20170602-083857",
                    "signature": "98B2BBF865C780873E53EB752AB37DC5402517A8",
                    "timestamp": "1496549198363",
                    "web_token": "10545055917999681651"
                }
            });
        </script>
        ...
        <div id="content">
            <div class="row">
                <div class="sub-menu">
                    <a href="http://yunxiu.f6car.com/kzf6/customerCar/customerCarList.do" class="active">普通客户</a>
                    <a href="http://yunxiu.f6car.com/kzf6/customerCar/customerCarListIncomplete.do">快速洗车客户</a>
                </div></div>
        ...
        <!--客户消费历史-->
        <div id="historyModal" class="modal fade in width1200" data-keyboard="false">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title">消费历史</h4>
            </div>
            <div class="modal-body">
        ...
        <div id="udesk_container">
            <div id="udesk_btn">
                <a style="display: block; position: fixed; box-sizing: border-box; font-size: 13px; color: rgb(255, 255, 255); text-align: center; cursor: pointer; text-decoration: none; z-index: 1000000000; border-width: 1px 1px 0px; border-top-style: solid; border-right-style: solid; border-left-style: solid; border-top-color: rgba(0, 0, 0, 0.1); border-right-color: rgba(0, 0, 0, 0.1); border-left-color: rgba(0, 0, 0, 0.1); border-image: initial; border-bottom-style: initial; border-bottom-color: initial; background-color: rgb(232, 151, 48); width: 40px; height: auto; padding: 10px 0px; right: 0px; bottom: 0px; margin-right: 0px;">
                    <span style="display:block;float:left;width:20px;height:20px;margin:10px 10px 0;background:url(http://app-widget-cdn-s0.b0.upaiyun.com/dist/images/icon-mq.png?v=npyjcj3l6o17nwmi) no-repeat 0 -20px;background-size:40px auto;margin:0 10px 10px;"></span>
                    <span style="display:block;float:left;width:1px;height:100%;background-color:rgba(0, 0, 0, .08);vertical-align:middle;background-color:#000\9;filter:alpha(opacity=10)\9;width:100%;height:1px;"></span>
                    <span id="udesk_btn_text" style="display:block;float:left;height:40px;margin:0 10px;line-height:40px;overflow-y:hidden; font-size: 13px; color: #fff;width:40px;height:auto;word-break:break-all;word-wrap:break-word;line-height:20px;letter-spacing:24px;overflow-y:auto;overflow-x:hidden;margin-top:10px;padding-left: 2px;">联系客服，在线咨询</span>
                    <span id="udesk_btn_circle" style="display:none;position:absolute;top:-13px;right:-13px;width:26px;height:26px;text-align:center;line-height:26px;font-size:14px;color:#fff;border-radius:15px;background-color: #ff3b30;left:-13px;"></span>
                </a>
            </div>
            <div id="udesk_panel" style="position:fixed;bottom:0;right:60px;z-index:-1;width:320px;height:480px;overflow:hidden;display:none;background-color:transparent;box-shadow:0 0 20px 0 rgba(0, 0, 0, .15);border:1px solid #ddd\9;">
                <iframe id="udesk_iframe" frameborder="0" scrolling="no" allowtransparency="true" style="width:100%;height:100%;border:none;padding:0;margin:0;float:none;background:none;" src="../others/saved_resource.html"></iframe>
            </div>
        </div>
        <script src="../others/free"></script>
    </body>
</html>